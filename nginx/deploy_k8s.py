...
ID = "931a89c0-d473-4077-836f-77dba10cbcf0"
...
def deploy_from_template():
    ...
    payload = {
        "name": "nginx-deployment-from-api",
...
def destroy_environment():
    ...
    try:
        ...
        r = response.json()
        print(f"Please navigate to: https://app.env0.com/p/{PROJECT_ID}/environments/{sys.argv[2]}?organizationId={ORGANIZATION_ID}")
        print(f"Environment {sys.argv[2]} is being destroyed.")
